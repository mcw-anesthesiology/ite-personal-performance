...
pub const BASIC_SCIENCES_ITEMS: [&str; 28] = [
...
pub const CLINICAL_SCIENCES_ITEMS: [&str; 42] = [
...
pub const ORGAN_BASED_SCIENCES_ITEMS: [&str; 67] = [
...
pub const CLINICAL_SUBSPECIALTIES_ITEMS: [&str; 44] = [
...
pub const SPECIAL_PROBLEMS_ITEMS: [&str; 14] = [
